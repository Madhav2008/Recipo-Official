...
class RecipeDatabase {
  static Future<void> addRecipe({
    ...
    DocumentReference documentReference = _recipeCollection.doc(
  ...
  static Stream<QuerySnapshot> readRecipesByCategory(category) {
    // String? userId = uid;
    print(category);
    Query collection = FirebaseFirestore.instance.collection('recipes').where(
          'category',
          isEqualTo: '${category} Recipe',
        );
